...
if( isset($_POST['fsubmit']) ){  
    ...
    $_SESSION['hcharmprice'] = $_POST["charmprice"];
    $_SESSION['hbeadingprice'] = $_POST["beadingprice"];
    // $_SESSION['hclasptype'] = ;
...
$shared_myzeey = $_POST['loadmoretext'];
/* template name: Load-design */
get_header();
...
if($loop->have_posts()){
    ...
    while ( $loop->have_posts() ) : $loop->the_post(); 
        // $title = get_the_title();
        // if($shared_myzeey == $title){
        $search_name = get_field('search_name');
        $clasp = get_field('clasp');
        $ld_braiding_one = get_field('braiding_one');
        $ld_braiding_two = get_field('braiding_two');
        $ld_braiding_three = get_field('braiding_three');
        $ld_braiding_four = get_field('braiding_four');
        $name_or_message = get_field('name_or_message');
        $splitMessage = str_split($name_or_message);
        $productId = 280;
        ...
        <div class="row">
            ...
            <div class="buy-now-right" id="style-1">
                <div class="buy-now-right-box">
                    <h6 class="buy-now-right-heading">OOPS</h6>
                    <div class="buy-now-right-box-desc">
                        <p>Sorry the design code you have entered does not exist.</p>
                    </div>
                    <a href="<?php echo site_url()."/buy-now/"; ?>" class="buy-now-link-style open-model-load-design">Continue</a>
                </div>
            </div>
        </div>
    </section>
            ...
            ?>
                <form action="<?php echo site_url();?>/buy-now" method="POST" id="buynowform">
                        ...
                        <div class="buy-now-search-form">
                            <div>
                                <div class="from-group">
                                    ...
                                    <!-- <input type="text" class="from-control" name="searchname" placeholder="Search" value="<?php echo $search_name;?>" id="messagename">
                    ...
                    <!-- <div class="buy-now-right-box">
                        ...
                        <a href="#" class="buy-now-link-style open-model">Load design</a>
                            ...
                            <ul class="color-piker clasp-section">
                                <?php
                                    ...
                                    foreach($clasp_terms as $clasp_terms_list){
                                        ...
                                        if($clasp_terms_list->slug == $clasp){
                                        ...
                                        ?>
                                            ...
                                            <div class="lengend-action-buttons">
                                                <label >
                                                    ...
                                                    <span name="clasptype" class="clasptype getpriceajax <?php echo $clasp_terms_list->slug; ?>" data-name="<?php echo $clasp_terms_list->slug; ?>" data-actualname="<?php echo $clasp_terms_list->name; ?>" data-src="<?php echo $color_image; ?>,<?php echo $color_image_back;?>">
                                                        <style>
                                        ...
                                        <ul class="color-piker">
                                            <?php
                                                ...
                                                foreach($braiding_one as $braiding_one_list){
                                                    ...
                                                    $default = ""; 
                                                    if($braiding_one_list->slug == $ld_braiding_one){
                                                        $default = 'checked="checked"';
                                                    }
                                                    ?>
                                                    <li>
                                        ...
                                        <ul class="color-piker">
                                            <?php
                                                ...
                                                foreach($braiding_two as $braiding_two_list){
                                                    ...
                                                    $default = ""; 
                                                    if($braiding_two_list->slug == $ld_braiding_two){
                                                        $default = 'checked="checked"';
                                                    }
                                                    ?>
                                                    <li>
                                        ...
                                        <ul class="color-piker">
                                            <?php
                                                ...
                                                foreach($braiding_three as $braiding_three_list)
                                                {
                                                    ...
                                                    $default = ""; 
                                                    if($braiding_three_list->slug == $ld_braiding_three){
                                                        $default = 'checked="checked"';
                                                    }
                                                    ?>
                                                    <li>
                                        ...
                                        <ul class="color-piker">
                                            <?php
                                                ...
                                                foreach($braiding_four as $braiding_four_list)
                                                {
                                                    ...
                                                    $default = ""; 
                                                    if($braiding_four_list->slug == $ld_braiding_four){
                                                        $default = 'checked="checked"';
                                                    }
                                                    ?>
                                                    <li>
                    ...
                    <div class="buy-now-right-box3">
                        ...
                        <div class="buy-now-form2">
                            <div>
                                <div class="from-group">
                                    <input type="text" class="from-control getpriceajax" name="fname" placeholder="Max. 10 characters" value="<?php echo $name_or_message;?>" id="fname">
                            ...
                            <ul class="img-list-create">
                                ...
                                $beadingtotalprice = 0;
                                    if( have_rows('acf_pb_beading_type_listing', $productId) ):
                                        ...
                                        $bead_row = get_field('selected_beading');
                                        $beading = get_sub_field('acf_pb_btl_type_name');
                                        $beading_image = get_sub_field('acf_pb_btl_type_image');
                                        $beadingprice = get_sub_field('acf_pb_btl_type_price');
                                                        for($i = 0; $i < count($bead_row); $i++){
                                                            if($beading == $bead_row[$i]['beading_name']){
                                                                $checked = "checked" ;
                                            ...
                                            ?>
                                                <li>
                                                    ...
                                                    <div class="from-group same-shipping-checkbox">
                                                            ...
                                                            <img src="<?php echo $beading_image; ?>">
                                                            
                                                            <input type="checkbox" name="beadingtype[]" class="beadingtype getpriceajax" value="<?php echo get_sub_field("acf_pb_btl_type_name"); ?>" data-image="<?php echo get_sub_field("acf_pb_btl_type_image"); ?>" <?php echo $checked; ?> data-price="<?php echo get_sub_field("acf_pb_btl_type_price"); ?>">
                            ...
                            <ul class="img-list-create add-some-charm">
                                ...
                                $charmtotalprice = 0;
                                    if( have_rows('acf_pc_charm_listing', $productId) ):
                                        ...
                                        $acf_pc_type_name = get_sub_field('acf_pc_type_name');
                                        $acf_pc_type_image = get_sub_field("acf_pc_type_image");
                                        $charmprice = get_sub_field('acf_pc_type_price');
                                        $charm_row = get_field('selected_charms');
                                        for($i = 0; $i < count($charm_row); $i++){
                                            if($acf_pc_type_name == $charm_row[$i]['charm_name']){
                                                $checked = "checked" ;
                                            ...
                                            ?>
                                                <li>
                                                    ...
                                                    <div class="from-group same-shipping-checkbox">
                                                            <label class="same-shipping-checkbox-label">
                                                            <img src="<?php echo  $acf_pc_type_image?>">
                                                            <input type="checkbox" name="charmtype[]" class="charmtype getpriceajax" value="<?php echo $acf_pc_type_name; ?>"  data-image="<?php echo $acf_pc_type_image; ?>" <?php echo $checked;?> data-price="<?php echo $charmprice; ?>">
                    ...
                    <div class="buy-now-right-box4 table-design buy-now-mb-8">
                        ...
                        <tr>
                            <?php 
                                ...
                                {
                                    $countcharm = 0;
                                    foreach( $charm_row as $charm_row_list )
                                    {
                                        // array_push($charmvalue, $charm_row_list);
                                        $countcharm++;
                                    }
                                }
                            ?>
                        ...
                        <tr>
                            <?php 
                                ...
                                {
                                    $countbeading = 0;
                                    foreach( $bead_row as $bead_row_list )
                                    {
                                        $countbeading++;
                                    }
                                }
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        var currentName = "<?php echo $search_name; ?>";
        ...
        //                     if( response == "success" )
        //                     {
        //                         jQuery(".searchresult").html(data).show(); 
        //                     }
        //                 }
        //            });
        //         }
        ...
        var loaddesignsearchvalue = jQuery('select[name=searchname]').val();
        if(jQuery('select[name=searchname]').length > 1 ){
            jQuery(".textred.open-model").hide();
            jQuery('.search-after-display').show();
        }
        ...
        jQuery("body").on('click', '#sharebtn', function(event) {
            ...
            var searchname      = jQuery('select[name=searchname]').val();
            ...
            jQuery.ajax({
                ...
                success: function(data,response)
                {
                    ...
                    {
                        console.log(data);
                        window.location.href="https://www.devopserver.com/projects/myzeey/share-page/";
